...
<body>
    ...
    <main class="container">
        ...
        <form>
            ...
            <input type="button" id="boton-buscar" onclick="ejemplo();" value="🔍"></input>
        </form>
        <br>
        <div class="info">
            Juan Ramírez - me@juangabrielramirez<br>
            <a href="https://github.com/juangramirez"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
   ...
   <script>
    function ejemplo(){
        var busque = document.getElementById("busqueda").value;
        location.href='https://duckduckgo.com/?q='+busque;
    }
    </script>
</body>
</html>